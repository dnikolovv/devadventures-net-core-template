...
namespace $safeprojectname$.Configuration
{
    public static class DependenciesConfiguration
    {
        ...
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
                setup.SwaggerDoc("v1", new Info { Title = "$safeprojectname$", Version = "v1" });
                setup.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "$safeprojectname$.Documentation.xml"));
